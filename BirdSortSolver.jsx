...
const BirdSortSolver = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-100 to-blue-200 p-4 pb-16">
      <div className="max-w-7xl mx-auto">
                  ...
                  return (
                    <div key={branchIndex} className="relative">
                      ...
                      <div className="relative">
                        {/* Birds container */}
                        <div 
                          className={`flex items-end gap-1 pb-1 ${isOddBranch ? "" : "flex-row-reverse"}`}
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-blue-900 to-indigo-900 text-white py-2 px-4 shadow-lg">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className="text-sm font-semibold">Current Puzzle:</span>
              <span className="text-sm bg-white bg-opacity-20 px-3 py-1 rounded">
                {puzzleName || "Untitled"}
              </span>
            </div>
            <div className="text-xs text-blue-200">
              {branches.length} branches × {birdsPerBranch} birds
            </div>
          </div>
        </div>
